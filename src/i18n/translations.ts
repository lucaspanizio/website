...
export const translations: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    'course.1.title':  'Next.js',
    'course.1.period': '2026 · 45h',
    'course.1.desc':   'Curso voltado ao desenvolvimento de aplicações com Next.js, abordando SSR, SSG, ISR, roteamento via pages e app router e Server Components.',
    'course.2.title':  'Angular',
    'course.2.period': 'Jan 2026 · 11h',
    'course.2.desc':   'Curso introdutório de Angular v21, com abordagem da estrutura do framework, componentes e fluxo básico de dados.',
    'course.3.title':  'Tailwind CSS',
    'course.3.period': 'Ago 2025 · 16h',
    'course.3.desc':   'Curso voltado a construção de layouts responsivos com Tailwind CSS v4, incluindo customização de tema e composição de utilitários.',
    'course.4.title':  'Javascript ES6',
    'course.4.period': 'Jul 2025 · 74h',
    'course.4.desc':   'Curso de JavaScript moderno (ES6+), abrangendo módulos, closures, manipulação do DOM, consumo de APIs com fetch e programação assíncrona.',
    'course.5.title':  'React Profissional',
    'course.5.period': 'Abr 2025 · 27h',
    'course.5.desc':   'Curso de React com foco em Styled Components, documentação de componentes com Storybook e testes automatizados com Jest.',
    'course.6.title':  'React.js',
    'course.6.period': 'Mar 2025 · 50h',
    'course.6.desc':   'Curso completo sobre o ecossistema React, incluindo componentes, estado, integração com bibliotecas, testes e processos de build e deploy.',
    'course.7.title':  'Comunicação e Oratória',
    'course.7.period': 'Set 2023 · 16h',
    'course.7.desc':   'Curso de comunicação e oratória em contexto profissional com teoria e prática sob mentoria de Cinthia Erika.',
  },
  ...
  en: {
    ...
    'course.1.title':  'Next.js',
    'course.1.period': '2026 · 45h',
    'course.1.desc':   'Course focused on application development with Next.js, covering SSR, SSG, ISR, routing via pages and app router, and Server Components.',
    'course.2.title':  'Angular',
    'course.2.period': 'Jan 2026 · 11h',
    'course.2.desc':   'Introductory Angular v21 course covering framework structure, components, and basic data flow.',
    'course.3.title':  'Tailwind CSS',
    'course.3.period': 'Aug 2025 · 16h',
    'course.3.desc':   'Course focused on building responsive layouts with Tailwind CSS v4, including theme customization and utility composition.',
    'course.4.title':  'Javascript ES6',
    'course.4.period': 'Jul 2025 · 74h',
    'course.4.desc':   'Modern JavaScript (ES6+) course covering modules, closures, DOM manipulation, API consumption with fetch, and asynchronous programming.',
    'course.5.title':  'Professional React',
    'course.5.period': 'Apr 2025 · 27h',
    'course.5.desc':   'React course focusing on Styled Components, component documentation with Storybook, and automated testing with Jest.',
    'course.6.title':  'React.js',
    'course.6.period': 'Mar 2025 · 50h',
    'course.6.desc':   'Comprehensive course on the React ecosystem, including components, state management, library integration, testing, and build and deploy processes.',
    'course.7.title':  'Communication & Public Speaking',
    'course.7.period': 'Sep 2023 · 16h',
    'course.7.desc':   'Communication and public speaking course in a professional context with theory and practice under the mentorship of Cinthia Erika.',
  },
};
